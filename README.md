# Relational Sorting
A conversion of the original program in C++ to C#, largely for practice purposes as well as future GUI integration.
---
...
Current implementation is CLI only but that is subject to future changes.
